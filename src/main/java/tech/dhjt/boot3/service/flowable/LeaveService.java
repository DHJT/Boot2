...
public class LeaveService {
    ...
    public String startLeaveProcess(String applicantName, String reason, Integer days) {
        ...
        log.info("请假流程已启动，流程实例ID: {}, 申请人: {}, 天数: {}", processInstance.getId(), applicantName, days);
    ...
    public void completeTask(String taskId, Boolean approved, String comment) {
        ...
        log.info("任务 {} 已完成，审批结果: {}, 意见: {}", taskId, approved, comment);
    }
    ...
    private Map<String, Object> buildProcessInfo(String processInstanceId, String status) {
        ...
        List<HistoricTaskInstance> historicTasks = historyService.createHistoricTaskInstanceQuery()
                .processInstanceId(processInstanceId)
                .finished()
                .orderByHistoricTaskInstanceEndTime().desc() // 倒序
                .list();
...
//                    .includeProcessVariables()
        ...
        if ("running".equals(status)) {
            ...
            for (Task task : currentTasks) {
                ...
                timeline.addFirst(node); // 插入到最前面（最新）
            }
        }
